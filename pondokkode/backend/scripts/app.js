...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        $('#form-import-guru').hide();
        $('#btn-import-guru').click(function (){
            $('#table-guru').hide();
            $('#navbar-guru').hide();
            $('#form-import-guru').show();
        });
        
        $('#cancel-form-import').click(function (){
            $('#form-import-guru').hide();
            $('#table-guru').show();
            $('#navbar-guru').show();
        });
        
        $('#form-import-siswa').hide();
        $('#btn-import-siswa').click(function (){
            $('#table-siswa').hide();
            $('#navbar-siswa').hide();
            $('#form-import-siswa').show();
        });
        
        $('#cancel-form-siswa').click(function (){
            $('#form-import-siswa').hide();
            $('#table-siswa').show();
            $('#navbar-siswa').show();
        });
